...
3) When the Reducer runs, it returns that array of objects (each object 
...
6) The instant the LibraryList component is about to render on the screen, the Connect 
  function activates, and grabs the state from the Provider.
  ╰─➤The Provider gives the state that's in the Store.
